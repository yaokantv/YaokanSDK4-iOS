...
- (IBAction)powerOnAction:(id)sender {
    [YaokanSDK sendRemoteMatchingWithYkcId:[[YKCenterCommon sharedInstance] currentYKCId] matchDevice:_matchDevice cmdkey:KeyPowerOn completion:^(BOOL result, NSError * _Nonnull error) {}];
...
- (IBAction)powerOffAction:(id)sender {
    ...
    [YaokanSDK sendRemoteMatchingWithYkcId:[[YKCenterCommon sharedInstance] currentYKCId] matchDevice:_matchDevice cmdkey:KeyPowerOff completion:^(BOOL result, NSError * _Nonnull error) {}];
}
